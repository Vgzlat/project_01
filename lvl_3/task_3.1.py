...
try:
    ...
    print(f'Элемент с индексами ({ii},{jj}) =', m1.get_Matrix(ii,jj))
except:
...
try:
    ...
    vv = int(input(f'Элемент с индексами ({ii},{jj}) имеет значение {m1.get_Matrix(ii,jj)}, укажите новое значение: '))
